...
<template>
    <div class="restaurants container">
      ...
      <h1 class="title page-header">Gestionnaire de restaurants</h1>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr v-for="r in restaurants">
                    <td>{{r.name}}</td>
                    <td>{{r.cuisine}}</td>
                    <td><router-link class="button" style="border-color: #555; color: #555" v-bind:to="'/restaurants/'+r._id">Détails</router-link></td>
                </tr>
            </tbody>
        </table>
    </div>
