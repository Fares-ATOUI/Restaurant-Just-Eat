      ...
      <div class="">
        <div class="form-row">
          <div class="form-group">
            <label>Classe </label>
            <input type="text" class="form-control input" style="width: 60px" v-model="grades.grade" placeholder="A - Z">
          </div>
          <div class="form-group">
            <label>Nom </label>
            <input type="text" class="form-control input" style="width: 500px" v-model="name" placeholder="Nom du restaurant" name="nom">
          </div>
          <div class="form-group ">
            <label>Cuisine </label>
            <input type="text" class="form-control input" style="width: 500px" v-model="cuisine" placeholder="Type de cuisine" name="cuisine">
          </div>
        </div>
        <br>
        <hr>
        <div class="form-row">
          <div class="form-group ">
            <label>N° </label>
            <input type="text" style="width: 60px" class="form-control input" v-model="address.building" placeholder="123">
          </div>
          <div class="form-group ">
            <label for="inputAddress">Address</label>
            <input type="text" style="width: 1070px" class="form-control input" v-model="address.street" placeholder="Avenue, Boulevard, Rue...">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group ">
            <label>Ville</label>
            <input type="text" class="form-control input" v-model="borough" placeholder="Ville">
          </div>
          <div class="form-group ">
            <label>Code postal</label>
            <input type="text" class="form-control input" v-model="address.zipcode" placeholder="Code postal">
          </div>
        </div>
